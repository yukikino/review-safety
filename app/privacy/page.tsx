  ...
  return (
    <main className="min-h-screen bg-white">
      <div className="container mx-auto px-4 md:px-6 lg:px-8 py-8 md:py-12 lg:py-16 max-w-4xl">
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 md:mb-8 text-gray-900">
          プライバシーポリシー
        </h1>

        <div className="prose prose-blue max-w-none">
          <section className="mb-6 md:mb-8">
            <p className="text-sm md:text-base mb-6 md:mb-8 text-gray-600 leading-relaxed">
          ...
          <section className="mb-6 md:mb-8">
            ...
            <p className="mb-4 text-sm md:text-base text-gray-600 leading-relaxed">
          ...
          <section className="mb-6 md:mb-8">
            ...
            <ul className="list-disc pl-5 md:pl-6 mb-4 space-y-2 text-sm md:text-base text-gray-600">
              <li>お問い合わせへの対応のため</li>
          ...
          <section className="mb-6 md:mb-8">
            <p className="text-xs md:text-sm mt-8 md:mt-12 text-gray-600">
              制定日：2025年1月1日<br />
              最終更新日：2025年1月1日
            </p>
          </section>
