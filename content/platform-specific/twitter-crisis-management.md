...
### Q1: 炎上したツイートは削除すべきですか、残すべきですか？

**A**: RT数が100以下でまだ拡散していない段階なら削除が有効です。しかしRT数1,000以上でまとめサイトに転載済みの場合は、削除しても広まっており「証拠隠滅」と批判されるリスクがあります。削除する場合は必ずスクリーンショットを保存し、謝罪ツイートで削除した旨に言及してください。

### Q2: 炎上時に誹謗中傷のリプライが大量に来た場合、全てに返信すべきですか？

**A**: 誹謗中傷や攻撃的なリプライには返信しないでください。返信すると必ず炎上が拡大します。建設的な意見や謝罪を受け入れてくれたリプライにのみ返信し、脅迫や個人情報の暴露が含まれるリプライはTwitterに通報してください。

### Q3: まとめサイトに炎上記事が転載された場合、削除してもらえますか？

**A**: まず、サイトの「お問い合わせ」から削除依頼を送ってください。応じてもらえない場合は弁護士を通じて法的根拠を示した削除請求書を送付し、それでも削除されなければ裁判所への仮処分申請も検討できます。費用は1サイトあたり10万円〜30万円が目安です。
