...
![Twitter炎上規模の判定フローチャート：RT数・リプライ数・まとめサイト転載](画像を追加してください)
...
![炎上初動24時間のタイムライン：0-1時間、1-3時間、3-6時間、6-24時間](画像を追加してください)
...
![ツイート削除判断チャート：削除すべきケース vs 残すべきケース](画像を追加してください)
...
![Twitter通報手順のスクリーンショット付き解説](画像を追加してください)
...
![Google検索結果からの削除依頼手順](画像を追加してください)
...
![SNS投稿前チェックリスト：誤字脱字、誤解を招く表現、差別的表現](画像を追加してください)
