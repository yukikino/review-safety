...
![ホットペッパーとGoogleマップ・食べログの返信機能比較表](./images/hotpepper-comparison-table.png)
...
![ホットペッパー返信画面のスクリーンショット](./images/hotpepper-reply-screen.png)
...
![ホットペッパー削除申請フォームの操作手順](./images/hotpepper-deletion-form.png)
...
![ホットペッパーとGoogleマップの優先順位判断フローチャート](./images/hotpepper-priority-flowchart.png)
...
![美容室特有のクレーム事例とその対応パターン](./images/beauty-salon-complaint-patterns.png)
...
### Q1: ホットペッパーの口コミ返信期限30日を過ぎてしまった場合、どうすればよいですか？

**A**: 30日を過ぎると返信枠が閉じてしまい、そのレビューには返信できなくなります。ポリシー違反のレビューであれば削除申請は引き続き可能です。今後は低評価レビューが来たら即座に返信する運用体制を整え、毎日の口コミチェックを習慣化してください。

### Q2: ポイント目的の虚偽レビューを削除してもらえますか？

**A**: 来店記録がないことを予約システムのログなどで証明できれば、リクルート社に削除依頼を出すことが可能です。「ポイント目的のレビューです」と直接指摘するのではなく、「予約記録に該当するお客様の来店記録がございません」と客観的な証拠に基づいて申請してください。

### Q3: 無料掲載プランのままで口コミに対応する方法はありますか？

**A**: 無料掲載では口コミ返信機能が使えませんが、削除申請は可能です。また、Googleマップでは無料で返信できるため、そちらで誠意ある対応を示す方法もあります。低評価レビューが複数ある場合は、費用対効果を考慮してホットペッパーの有料プランへの加入を検討してください。
