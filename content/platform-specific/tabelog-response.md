...
> **💡 ヒント**: 軽度のクレームへの対応は[軽度クレーム対応一覧](/mild-response/)、業種別の対応は[業種別対応一覧](/industry-specific/)をご覧ください。プラットフォーム別対応の他の記事は[プラットフォーム別対応一覧](/platform-specific/)で確認できます。飲食店向け対応は[飲食店の口コミ対応](/industry-specific/restaurant)もご参照ください。
...
### Q1: 食べログの店舗会員に加入しないと口コミに一切返信できませんか？

**A**: はい、食べログで口コミに返信するには店舗会員（有料プラン、月額約1万円〜）への加入が必須です。無料掲載のままでは返信機能が使えません。ただし、削除申請は店舗会員でなくても可能ですので、ポリシー違反のレビューには削除依頼で対応できます。

### Q2: 食べログの返信期限90日を過ぎた低評価レビューにはどう対処すればよいですか？

**A**: 90日を過ぎると返信枠が閉じるため、そのレビューには返信できなくなります。ポリシー違反がある場合は削除申請が可能です。また、Googleマップなど他のプラットフォームで誠意ある対応を示すことで、全体的な店舗の印象を改善する方法もあります。

### Q3: 同業者からの嫌がらせレビューを食べログで削除してもらえますか？

**A**: 食べログは「利害関係者によるレビュー」を禁止していますが、証拠がないと削除は認められません。短期間に複数の低評価レビューが集中している場合は食べログサポートに報告し、IPアドレスや投稿タイミングの分析を弁護士に依頼して証拠を収集することも検討してください。
