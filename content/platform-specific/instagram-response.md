...
### Q1: Instagramのネガティブコメントは削除すべきですか、返信すべきですか？

**A**: 誹謗中傷・スパム・個人情報の暴露は削除して問題ありません。一方、接客や料理への正当な不満は削除すると「都合の悪いコメントを消している」と批判されるため、簡潔に謝罪して改善策を示す返信で対応してください。判断に迷う場合は返信を優先するのが安全です。

### Q2: インフルエンサーからのネガティブ投稿には、すぐに返信すべきですか？

**A**: フォロワー数の多いインフルエンサーの場合、感情的に即座に返信すると炎上リスクが高まります。まず冷静になって状況を把握し、フォロワー1万人以上の場合は弁護士に相談することも検討してください。対応は必ずDMで行い、公開の場での反論は避けてください。

### Q3: ストーリーズでネガティブなメンションを受けた場合、リポストして反論してもよいですか？

**A**: ネガティブなストーリーズメンションは絶対にリポストしないでください。リポストすると自分のフォロワーにもネガティブな内容が拡散されてしまいます。ストーリーズは24時間で消えるため、基本的には投稿者にDMで謝罪・改善策を伝え、24時間待つ対応が推奨されます。
