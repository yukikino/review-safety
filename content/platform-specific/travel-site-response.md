...
> **💡 ヒント**: 軽度のクレームへの対応は[軽度クレーム対応一覧](/mild-response/)、業種別の対応は[業種別対応一覧](/industry-specific/)をご覧ください。プラットフォーム別対応の他の記事は[プラットフォーム別対応一覧](/platform-specific/)で確認できます。宿泊施設向け対応は[ホテル・宿泊施設対応](/industry-specific/hotel)、削除申請は[Google口コミ削除依頼](/escalation/google-review-deletion)もご参照ください。
...
### Q1: じゃらん・楽天トラベルの返信は何文字まで書けますか？

**A**: じゃらん・楽天トラベルともに返信は500文字以内です。Googleマップの4,096文字と比べて短いため、簡潔にまとめる工夫が必要です。謝罪、改善策、再来訪の促進をコンパクトに盛り込み、詳細な説明は施設への直接問い合わせに誘導してください。

### Q2: 写真付きの低評価レビューで部屋の汚れを晒された場合、どう対応すべきですか？

**A**: 写真付きの低評価レビューはダメージが大きいため、即座に該当箇所の清掃・修繕を実施してください。返信では「ご指摘を受けまして即座に該当箇所の清掃・修繕を実施いたしました」と対応済みであることを明記し、チェック体制の強化を約束することで、他の予約検討者に安心感を与えられます。

### Q3: 「立地」の評価が低い場合、変えられない要素にどう返信すべきですか？

**A**: 立地は変えられないため、代替サービスをアピールしてください。「事前にご連絡いただければ無料送迎サービスをご利用いただけます」のように利便性を補う情報を提供し、ホームページにアクセス情報を詳しく掲載する改善を行うことで、今後の低評価を防げます。
