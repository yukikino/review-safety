...
> **💡 ヒント**: 軽度のクレームへの対応は[軽度クレーム対応一覧](/mild-response/)をご覧ください。業種別対応の他の事例は[業種別対応一覧](/industry-specific/)で確認できます。賠償・返金対応は[金銭要求への対応](/escalation/money-demand-settlement)、接客態度クレームは[スタッフ態度クレーム対応](/mild-response/staff-attitude-complaint)もご参照ください。
...
### Q1: クリーニング事故の賠償額は購入価格全額を支払う必要がありますか？

**A**: いいえ、クリーニング事故賠償基準では購入価格ではなく時価で賠償します。購入後の経過年数に応じた補償割合を計算し、さらにクリーニング代金の40倍が上限となります。賠償額の算定は公開返信ではなく、店舗で個別に説明してください。

### Q2: お客様が「元々の状態」と「クリーニング後の状態」の写真を持っていない場合、賠償責任はありますか？

**A**: 写真の有無にかかわらず、受付時に衣類の状態を確認・記録していなければ、クリーニング店側が不利になります。受付時に衣類の状態を写真撮影し、受付票に記載してお客様の署名をもらうことで、トラブル時の証拠となります。

### Q3: 口コミで「服が破れた」と書かれた場合、経年劣化が原因でも謝罪すべきですか？

**A**: 公開返信では原因の特定を避け、まず謝罪と店舗への来店を促す対応が適切です。「経年劣化です」と断言すると責任逃れと批判され炎上リスクがあります。原因調査と賠償基準に基づく対応は、非公開の場で個別に行ってください。
