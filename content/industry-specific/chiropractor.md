...
> **💡 ヒント**: 軽度のクレームへの対応は[軽度クレーム対応一覧](/mild-response/)をご覧ください。業種別対応の他の事例は[業種別対応一覧](/industry-specific/)で確認できます。医療機関の対応は[歯科医院の口コミ対応](/industry-specific/dental-clinic)、名誉毀損対応は[名誉毀損対応マニュアル](/escalation/defamation-handling)もご参照ください。
...
### Q1: 口コミ返信で「施術」と「治療」のどちらを使うべきですか？

**A**: 整体院・接骨院は医療機関ではないため、口コミ返信では必ず「施術」を使用してください。「治療」「治す」「治る」は医療行為を示唆する表現としてあはき法・柔道整復師法に違反する可能性があり、行政指導の対象となります。

### Q2: 保険適用の有無について口コミ返信で説明しても問題ありませんか？

**A**: 保険適用範囲を正確に説明することは問題ありません。ただし「全ての施術に保険が使えます」のような誤解を招く表現は避け、「健康保険が適用されるのは急性・亜急性の外傷（捻挫、打撲、挫傷など）のみとなります」と正確に伝えてください。

### Q3: 「効果がなかった」という口コミに対して、施術回数が少なかったことを指摘してもよいですか？

**A**: 公開返信で「施術回数が足りない」とお客様の責任を示唆する表現は、責任転嫁と受け取られ炎上リスクがあります。「効果の実感には個人差がございます」と伝えた上で、「直接当院までお問い合わせください」と個別対応に誘導する方が安全です。
