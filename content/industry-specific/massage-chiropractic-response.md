...
### Q1: 整体院の口コミ返信で「肩こりが和らぎます」という表現は使えますか？

**A**: 「和らぐ」「楽になる」という表現は「治る」「治療」に比べてリスクは低いですが、断定的に使うと景品表示法違反の優良誤認に該当する可能性があります。「肩の張りが和らぐことがあります」のように可能性を示す形で使い、「効果には個人差がございます」と必ず付記してください。

### Q2: 「無資格者が施術している」という口コミを書かれた場合、資格証のコピーを返信に添付すべきですか？

**A**: Googleマップなどの口コミ返信に画像を添付する機能はないため、資格証のコピーは添付できません。「当院のスタッフは全員が国家資格または民間資格を保有しております。資格情報は店内およびホームページに掲示しております」と返信し、確認できる場所を案内してください。

### Q3: 施術後に痛みが悪化したという口コミへの返信で、揉み返しについて説明してもよいですか？

**A**: 「揉み返し」について一般的な説明をすることは可能ですが、お客様の症状を断定することは避けてください。公開返信では「施術後に痛みが出てしまい申し訳ございませんでした」と謝罪し、「詳しくお話をお伺いしたく、店舗までご連絡ください」と個別対応に誘導する形が安全です。
