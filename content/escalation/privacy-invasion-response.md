...
![対応フローチャート](./images/privacy-invasion-response-flowchart.png)
...
> **💡 ヒント**: 軽度のクレームへの対応は[軽度クレーム対応一覧](/mild-response/)をご覧ください。エスカレーション対応の他のケースは[エスカレーション対応一覧](/escalation/)で確認できます。盗撮・プライバシー侵害以外の法的対応は[名誉毀損対応マニュアル](/escalation/defamation-handling)、削除申請は[Google口コミ削除依頼](/escalation/google-review-deletion)もご参照ください。
...
### Q1: 料理の写真に他のお客さんの顔が写り込んでいる場合、削除申請できますか？

**A**: はい、人の顔が明確に写っている写真は肖像権侵害としてGoogleマップに削除申請が可能です。「プライバシーの侵害」を理由に報告し、「写っている人物の許可を得ていない」と詳細欄に記載してください。ただし、顔がぼやけて判別できない程度であれば削除されにくい傾向があります。

### Q2: スタッフの顔写真を無断で口コミに投稿された場合、損害賠償を請求できますか？

**A**: はい、スタッフの顔写真の無断投稿は肖像権侵害に該当し、損害賠償請求が可能です。判例では30万円程度の賠償命令が出たケースがあります。まずはプラットフォームへの削除申請を行い、削除されない場合は弁護士を通じて発信者情報開示請求と損害賠償請求を検討してください。

### Q3: 店内での無断撮影を防ぐために、撮影禁止にしてもよいですか？

**A**: 店舗の判断で撮影ルールを設けることは合法です。ただし、完全撮影禁止にすると集客に悪影響が出る場合もあるため、「料理のみ撮影OK、他のお客様やスタッフが写らないようご配慮ください」という柔軟なルールがおすすめです。ルールは店内の目立つ場所に掲示し、トラブル時の削除申請の根拠としても活用できます。
