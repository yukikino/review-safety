...
### Q1: 「食中毒になった」という口コミに対して謝罪してもよいですか？

**A**: 「食中毒を引き起こしてしまい申し訳ございません」のような謝罪は絶対にしないでください。因果関係が証明されていない段階で食中毒を認める謝罪をすると、損害賠償請求の証拠に使われます。返信は「体調についてご心配しております」と気遣いを示しつつ、「保健所または当店まで直接ご連絡ください」と誘導する形にしてください。

### Q2: 食中毒疑惑の口コミが嘘だと分かった場合、どう対応すべきですか？

**A**: まず来店記録がないこと、保健所への食中毒報告がないことなどの証拠を集めてください。その上でGoogleマップや食べログに「虚偽の情報による営業妨害」として削除申請を出します。削除されない場合は、弁護士に相談して発信者情報開示請求や名誉毀損・営業妨害での損害賠償請求を検討してください。

### Q3: 保健所から連絡が来た場合、弁護士の立会いは必要ですか？

**A**: 複数の食中毒疑惑がある場合、口コミで「訴える」と書かれている場合、保健所の質問内容が営業停止を前提としている場合は、弁護士の立会いを推奨します。保健所の調査自体には必ず協力する必要がありますが、弁護士が同席することで不利な発言を防ぎ、適切な対応を取ることができます。
