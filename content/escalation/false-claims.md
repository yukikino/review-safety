...
description: "事実無根の口コミへの対処法を解説。公開返信の書き方、削除依頼の手順、証拠保存方法を実例付きで紹介します。"
date: "2025-01-13"
author: "編集部"
category: "escalation"
...
- 「来店していないのに★1レビューを書かれた」「事実と全く違う内容を書かれた」
- 公開返信で事実を伝えたいが、喧嘩腰にならないように対応したい
- 削除依頼を出すべきかどうか、判断基準が知りたい

この記事を読むことで、**事実と異なる口コミへの公開返信テンプレート、削除依頼の手順、証拠の残し方**が分かります。
...
- **「確認いたしましたが」**: 感情的にならず、事実確認をした上での返信であることを示す
- **具体的な事実のみを記載**: 「来店記録がない」「定休日だった」など、客観的な事実のみを伝える
- **問い合わせへの誘導**: 公開返信では争わず、「直接お問い合わせください」と誘導
- **謙虚な姿勢を維持**: たとえ事実と異なっても、「誠実な対応を心がけます」と締めくくる
