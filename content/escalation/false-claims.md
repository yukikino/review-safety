...
description: "事実無根の口コミへの対処法。予約システムでの来店記録照合、感情的にならない公開返信テンプレート、Googleへの削除依頼判断基準、スクリーンショットでの証拠保存手順を実例付きで解説します。"
date: "2025-01-13"
author: "編集部"
category: "escalation"
...
### Q1: 来店していない人が口コミを書いた場合、削除できますか？

**A**: 予約システムのログやPOSデータで来店記録がないことを証明できれば、Googleマップでは「スパム・虚偽のコンテンツ」として削除が認められる可能性があります。削除申請の際に「該当日の予約記録なし」「定休日だった」など具体的な証拠を添付することで、承認率が高まります。

### Q2: 事実と違う口コミへの公開返信で、どこまで反論してよいですか？

**A**: 「当日は定休日でした」「来店記録が見つかりませんでした」など、客観的で検証可能な事実のみを簡潔に記載してください。長文での反論や「嘘をつくな」などの攻撃的な表現は、第三者から「感情的な店」と受け取られ逆効果です。詳細は「直接お問い合わせください」と非公開の対話に誘導しましょう。

### Q3: 事実と違う口コミのスクリーンショットはいつ撮るべきですか？

**A**: 口コミを見つけたら直ちにスクリーンショットを撮ってください。投稿者が後から内容を編集・削除する可能性があるため、URL・投稿日時・全文が映るように保存します。可能であればウェブ魚拓（archive.org等）にも保存しておくと、法的手続きの際により強力な証拠になります。
