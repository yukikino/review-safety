...
![対応フローチャート](./images/money-demand-settlement-flowchart.png)
...
> **💡 ヒント**: 軽度のクレームへの対応は[軽度クレーム対応一覧](/mild-response/)をご覧ください。エスカレーション対応の他のケースは[エスカレーション対応一覧](/escalation/)で確認できます。脅迫・恐喝対応は[脅迫対応マニュアル](/escalation/threat-extortion-emergency)、名誉毀損対応は[名誉毀損対応マニュアル](/escalation/defamation-handling)もご参照ください。
...
### Q1: 「誠意を見せろ」と言われた場合、金銭を支払うべきですか？

**A**: 「誠意を見せろ」という曖昧な要求には応じないでください。まず「具体的な損害額と根拠を教えてください」と確認し、領収書や診断書などの証拠の提出を求めてください。具体的な損害の立証がない場合は支払い義務はありません。弁護士に相談した上で対応することを強くおすすめします。

### Q2: 口コミで「慰謝料を払え」と書かれた場合、公開返信すべきですか？

**A**: 金銭要求を含む口コミには、原則として公開返信しないことを推奨します。返信すると投稿者が口コミを削除し、証拠が消えてしまうリスクがあるためです。証拠を保全した上で、弁護士を通じて非公開で交渉する方が効果的です。どうしても返信が必要な場合は「弁護士と相談の上、適切に対応します」と簡潔に記載してください。

### Q3: 示談する場合、必ず示談書は必要ですか？

**A**: はい、必ず書面で示談書を作成してください。口頭での合意は「言った・言わない」のトラブルの原因になります。示談書には示談金額、支払い方法・期日、清算条項（今後一切の請求をしない旨）、口コミ削除の約束、秘密保持条項を含め、弁護士に作成を依頼するのが安全です。
