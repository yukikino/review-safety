...
![対応フローチャート](./images/discrimination-hate-speech-response-flowchart.png)
...
> **💡 ヒント**: 軽度のクレームへの対応は[軽度クレーム対応一覧](/mild-response/)をご覧ください。エスカレーション対応の他のケースは[エスカレーション対応一覧](/escalation/)で確認できます。名誉毀損・侮辱罪は[名誉毀損対応マニュアル](/escalation/defamation-handling)、削除申請は[Google口コミ削除依頼](/escalation/google-review-deletion)もご参照ください。
...
### Q1: 差別的な口コミは必ず削除してもらえますか？

**A**: 人種・民族、性的指向、障害を理由とした明確な攻撃的表現であれば、Googleマップや食べログで削除される可能性が高いです。ただし、「なんとなく気持ち悪い」などの曖昧な表現や、差別的意図が不明確な場合は削除されにくい傾向があります。削除申請が却下された場合は、より具体的な理由を添えて再申請してください。

### Q2: 差別的な口コミに対して公開返信すべきですか？

**A**: 基本的には返信しないことを推奨します。差別的口コミに返信すると、議論が紛糾して炎上するリスクがあります。他の閲覧者は投稿内容を見れば「異常な投稿」と判断できるため、削除申請を粛々と行う方が効果的です。どうしても返信する場合は、店の多様性尊重の方針を淡々と伝えるにとどめてください。

### Q3: ヘイトスピーチ解消法で相手を罰することはできますか？

**A**: いいえ、ヘイトスピーチ解消法には罰則規定がないため、この法律だけで相手を処罰することはできません。ただし、差別的発言が名誉毀損罪や侮辱罪の要件を満たす場合は刑事告訴が可能です。また、民事訴訟での損害賠償請求においては、ヘイトスピーチ解消法が違法性の根拠として活用できます。
