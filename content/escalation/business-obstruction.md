...
description: "営業妨害で訴える前に確認すべき法律知識。信用毀損罪・業務妨害罪の成立要件と具体的な判例、民事訴訟と刑事告訴の違い、警察への被害届提出手順を実例付きで詳しく解説します。"
date: "2025-01-13"
author: "編集部"
category: "escalation"
...
### Q1: 「まずい」「態度が悪い」という口コミでも営業妨害で訴えられますか？

**A**: いいえ、主観的な感想や意見は営業妨害には該当しません。信用毀損罪・業務妨害罪が成立するには、「虚偽の情報」であることが必要です。「食中毒を出した」「無許可営業している」など、事実と異なる具体的な情報を流布した場合に限り、法的措置の対象となります。

### Q2: 営業妨害で訴える場合、民事と刑事のどちらを選ぶべきですか？

**A**: 多くの場合、民事で損害賠償を請求する方が現実的です。刑事告訴は警察が受理しないケースも多く、起訴されない可能性もあります。一方、民事訴訟は弁護士に依頼すれば確実に手続きを進められます。まずは削除依頼を試し、それでも解決しない場合に弁護士と相談して判断してください。

### Q3: 営業妨害の証拠として何を残しておくべきですか？

**A**: 投稿のスクリーンショット（URL・投稿日時・全文を含む）、予約キャンセルの記録、売上推移のグラフ（投稿前後の比較）、顧客からの問い合わせ内容を保存してください。特にスクリーンショットは投稿が削除・編集される前に撮影することが重要で、複数の形式（画像・PDF）で保管しておくと安心です。
