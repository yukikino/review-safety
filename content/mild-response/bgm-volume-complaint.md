...
![BGM音量管理ガイド](./images/bgm-volume-management.png)
...
> **💡 ヒント**: 他の軽度クレームへの返信テンプレートは[軽度クレーム対応一覧](/mild-response/)で確認できます。「待たされた」「態度が悪い」「清潔感がない」など19種類のテンプレートを用意しています。騒音全般の対応は[騒音クレーム対応](/mild-response/noise-complaint)もご参照ください。
...
### Q1: BGMの音量について口コミでクレームを受けた場合、音量を変えるべきですか？

**A**: まずはクレームの内容を精査し、同様の指摘が複数あるかを確認してください。複数の指摘がある場合は音量調整が必要です。1件のみの場合でも、時間帯別の音量基準を設けて管理することをお勧めします。返信では「音量を見直しました」と改善済みであることを伝えましょう。

### Q2: 店舗のBGMに個人用のSpotifyやApple Musicを使っても大丈夫ですか？

**A**: いいえ、個人用の音楽配信サービスを店舗で使用するのは著作権法違反です。最大10年以下の懲役または1,000万円以下の罰金が科される可能性があります。USENやSpotify for Businessなど、業務用サービスを契約してください。著作権料も含まれているため安心です。

### Q3: 「BGMのセンスが悪い」という主観的な口コミにはどう返信すべきですか？

**A**: 店舗のコンセプトを簡潔に説明しつつ、お客様の意見を尊重する姿勢を見せましょう。「当店では落ち着いた雰囲気を大切にしておりますが、選曲の見直しも検討してまいります」のように、柔軟な姿勢を示すことがポイントです。「BGMが分からない方は来なくて結構」のような否定的な返信は絶対に避けてください。
