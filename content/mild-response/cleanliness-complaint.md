...
### Q1: 清掃は毎日しているのに「汚い」と口コミを書かれました。どう返信すべきですか？

**A**: 「毎日清掃しているので汚いはずがない」という否定は逆効果です。お客様が来店されたタイミングで清掃が行き届いていなかった可能性を認め、清掃頻度の見直しやチェックリストの導入など、具体的な改善策を示しましょう。「清掃頻度を1時間ごとに変更しました」のように数字で示すと説得力が増します。

### Q2: 「ゴキブリがいた」など事実と異なる口コミを書かれた場合、どう対応すべきですか？

**A**: 感情的に否定するのではなく、「確認したところ該当する事実は確認できませんでした」と冷静に伝えてください。その上で「ご不快な思いをさせてしまったことは申し訳ございませんでした」と謝罪を添えましょう。明らかな虚偽の場合は、プラットフォームへの削除依頼も検討できます。

### Q3: 清掃チェックリストはどのくらいの頻度で実施すべきですか？

**A**: トイレは最低1時間ごと、テーブルはお客様退店後の毎回、床は2時間ごとが目安です。飲食店の場合は保健所の基準も参考にしてください。チェックリストに担当者名と時間を記録しておくと、クレーム対応時の証拠にもなり、スタッフの意識向上にもつながります。
