...
### Q1: Wi-Fiの速度が遅いという口コミが来た場合、まず何を確認すべきですか？

**A**: まずルーターの設置場所と契約している回線プランを確認してください。家庭用ルーターを使っている場合は業務用への切り替えを検討しましょう。同時接続台数が多いことが原因の場合は、ルーターの増設やメッシュWi-Fiの導入が効果的です。回線速度は100Mbps以上を目安にすることをお勧めします。

### Q2: 長時間滞在を防ぐためにコンセントを設置しないのは問題ですか？

**A**: 店舗の方針として電源を設置しないこと自体は問題ありません。ただし、口コミで指摘された場合は「長居されたくないから」とは書かず、「多くのお客様にご利用いただくため」のように丁寧に方針を説明しましょう。カフェやコワーキングスペースでは電源需要が高いため、一部の席のみ電源を設ける折衷案も検討してください。

### Q3: Wi-Fiパスワードの案内方法として最も効果的なのは何ですか？

**A**: 各テーブルに案内カードを設置するのが最も効果的です。レシートにWi-Fi情報を印字する方法や、QRコードで接続できる仕組みも便利です。レジカウンターやトイレ前にも掲示しておくと見逃しを防げます。スタッフに聞きづらいと感じるお客様も多いため、目に見える場所に複数箇所掲示することがポイントです。
