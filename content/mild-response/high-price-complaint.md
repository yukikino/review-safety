...
description: "価格クレームへの返信例。料金体系の透明性を丁寧に示し、施術内容・カウンセリング・アフターケアを含むサービス全体の価値を適切に伝える書き方を実例付きで詳しく解説します。"
date: "2025-01-13"
author: "編集部"
...
薬機法や景品表示法については、[消費者庁の景品表示法ガイド](https://www.caa.go.jp/)や[厚生労働省の薬機法情報](https://www.mhlw.go.jp/)をご確認ください。
...
### Q1: 「高い」という口コミに対して、料金の内訳を詳しく説明してもよいですか？

**A**: 簡潔であれば問題ありません。「当店の料金には、カウンセリング、施術、アフターフォローが含まれております」程度の説明に留めましょう。ただし、長文で料金の妥当性を主張すると言い訳がましく見えるため、2〜3文以内にまとめることがポイントです。

### Q2: 「効果がない」という口コミに「効果には個人差があります」と書いても大丈夫ですか？

**A**: はい、「効果の実感には個人差がございます」という表現は適切です。薬機法や景品表示法の観点からも、効果を断定しない表現が求められます。ただし、この表現だけでは冷たい印象を与えるため、「ご期待に沿えず申し訳ございませんでした」という謝罪と、「直接店舗までご相談ください」という個別対応の余地も併せて示しましょう。

### Q3: 公開返信で次回割引を提案するのはNGですか？

**A**: はい、公開返信での割引提案は避けてください。「文句を言えば割引してもらえる」という前例を作り、他のお客様にも不公平感を与えます。代わりに「直接店舗までお問い合わせいただけますと幸いです」と案内し、個別対応として検討する方が適切です。
