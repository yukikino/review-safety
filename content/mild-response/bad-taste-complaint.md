...
### Q1: 「まずい」という口コミに対して、料理のこだわりを説明してもよいですか？

**A**: 短く簡潔であれば問題ありませんが、長文の説明は言い訳と受け取られます。「当店では〇〇の味を大切にしております」程度に留め、「お客様のご意見を参考に改善してまいります」と改善の姿勢を示す方が効果的です。300文字以上のこだわり説明は避けましょう。

### Q2: 同じ料理に対して「美味しい」と「まずい」の両方の口コミがある場合、どう対応すべきですか？

**A**: 味の評価は主観的なものなので、両方の声があるのは自然なことです。低評価の口コミには「お口に合わず申し訳ございませんでした」と謝罪し、「他のお客様は美味しいと言っている」という反論は避けてください。改善の姿勢を見せることで、潜在顧客に誠実な印象を与えられます。

### Q3: 「まずい」口コミが短期間に複数来た場合、何を最初に確認すべきですか？

**A**: まず調理担当者の変更や食材の仕入れ先変更がなかったかを確認してください。次に、同じ期間の他のレビューも確認し、特定の料理に集中していないかを分析します。レシピの文書化と毎日の味見を徹底し、味のブレをなくすことが根本的な対策になります。
