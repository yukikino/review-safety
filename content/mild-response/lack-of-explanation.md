...
description: "説明不足クレームへの返信例。カウンセリングシート新規導入、施術前の確認書面作成、スタッフによる二重チェック体制など説明プロセス全体の改善策を伝える書き方を実例付きで解説します。"
date: "2025-01-13"
author: "編集部"
...
### Q1: 「説明した」証拠があるのに「聞いていない」と口コミに書かれた場合、証拠を提示してよいですか？

**A**: 公開返信で「同意書にサインいただいております」と事実を淡々と伝えることは可能ですが、攻撃的な書き方は避けてください。その上で「ご理解いただけるよう十分な説明ができていなかったこと、お詫び申し上げます」と謙虚な姿勢を添えましょう。形式的に説明しただけでなく、理解してもらうことが重要だという認識を示すことがポイントです。

### Q2: 説明不足のクレームを防ぐ最も効果的な方法は何ですか？

**A**: 口頭説明に加えて、書面やタブレットで重要事項を確認してもらう「二重チェック体制」が最も効果的です。カウンセリングシートに料金明細を明記し、お客様にサインをいただく運用に変えることで、「言った言わない」のトラブルを大幅に減らせます。さらに、説明後に「ご質問はございますか？」と確認する時間を設けることも重要です。

### Q3: 美容クリニックとエステサロンでは、説明義務に違いはありますか？

**A**: はい、大きく異なります。美容クリニック（医療機関）にはインフォームドコンセント（説明と同意）の義務があり、施術の効果・リスク・副作用を書面で説明する必要があります。エステサロン（非医療）には医療レベルの説明義務はありませんが、消費者契約法に基づき、料金・契約条件・クーリングオフ制度の説明が求められます。
