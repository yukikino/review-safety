...
### Q1: キャンセル料を請求したら低評価をつけられました。返金すべきですか？

**A**: 公開返信で安易に返金を約束すると「文句を言えば返金してもらえる」という前例を作ってしまいます。規約に基づいた対応であれば返金の必要はありません。ただし、説明不足が原因の場合は、直接連絡で個別に対応を検討しましょう。公開返信では規約を丁寧に説明し、今後の案内方法の改善を約束するのが適切です。

### Q2: キャンセルポリシーを口頭でしか説明していない場合、法的に有効ですか？

**A**: 口頭説明だけでは「言った言わない」のトラブルになりやすく、証拠として弱いです。予約確認メールやSMSにキャンセルポリシーを明記し、予約サイトの確認画面にも表示することをお勧めします。書面やデジタル記録で同意の証拠を残すことで、トラブル時に店舗側の立場を守れます。

### Q3: 無断キャンセルの口コミに「連絡がなかった」と事実を書いてもよいですか？

**A**: 事実を伝えること自体は問題ありませんが、攻撃的な書き方は避けてください。「ご予約のお時間にご来店がなく、事前のご連絡もいただけなかったため」のように淡々と事実を述べ、「事前にご連絡いただければ柔軟に対応できる」と今後の案内を添えることで、第三者にも誠実な印象を与えられます。
