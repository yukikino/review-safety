...
description: "キャンセル料クレームへの返信例。規約に基づく丁寧な説明と返金対応の書き分けを実例で解説。"
date: "2025-01-13"
author: "編集部"
...
- Googleマップやホットペッパーで「キャンセルしたのに課金された」と書かれた
- キャンセルポリシーに基づいて対応したが、お客様が納得していない
- 規約を伝えつつ、他のお客様（潜在顧客）には誠実な店だと思ってもらいたい

この記事を読むことで、**そのままコピペして使える返信テンプレートと、キャンセルポリシーの説明方法**が分かります。
...
- **規約の明示**: 「予約時にご案内」「規約に基づき」と、ルールに基づいた対応であることを伝える
- **説明不足は認める**: 「説明が不十分だった」と謙虚な姿勢を示す
- **改善の意思を示す**: 「より分かりやすく説明」「予約確認メールに明記」など、具体的な改善策を提示
