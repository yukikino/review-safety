...
> **💡 ヒント**: 他の軽度クレームへの返信テンプレートは[軽度クレーム対応一覧](/mild-response/)で確認できます。「待たされた」「態度が悪い」「清潔感がない」など19種類のテンプレートを用意しています。飲食店向けの対応は[飲食店の口コミ対応](/industry-specific/restaurant)もご参照ください。
...
### Q1: 小規模飲食店でもアレルギー対応メニューは用意すべきですか？

**A**: 完全なアレルギー対応が難しい場合は、無理に対応メニューを用意する必要はありません。むしろ、対応できない理由を明確に説明し、「お客様の安全を第一に考えた判断」であることを伝える方が誠実です。メニューに七大アレルゲンの表示を追加するだけでも、大きな改善になります。

### Q2: アレルギー対応について「大丈夫です」と返信してしまった場合、どうすればよいですか？

**A**: すぐに返信を修正し、「効果の個人差がある」「微量混入のリスクがある」といった正確な情報に書き換えてください。「大丈夫です」という表現は、万が一事故が起きた場合に法的責任を問われるリスクがあります。今後の返信では「対応可能な範囲」を具体的に示し、安全面の注意事項も必ず添えましょう。

### Q3: 口コミで「アレルギー対応してくれなかった」と書かれた場合、対応不可の理由を詳しく書いてよいですか？

**A**: はい、対応できない理由を簡潔に説明することは重要です。「小規模な厨房で調理器具を完全に分けることが難しいため」のように、安全面を最優先にした判断であることを伝えましょう。ただし、長文の言い訳は避け、2〜3文程度にまとめることがポイントです。
