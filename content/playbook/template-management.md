...
cta: "tool"
howto:
  name: "口コミ返信テンプレートの構築手順"
  description: "口コミ返信テンプレートの作成から運用開始までの5ステップ。"
  totalTime: "PT5H"
  steps:
    - name: "過去の口コミを分析する"
      text: "過去6ヶ月分の口コミを収集し、クレーム内容をカテゴリ別に分類。頻出パターンを特定します。"
    - name: "テンプレート案を作成する"
      text: "頻出パターンごとに返信テンプレートを作成。謝罪・共感・改善提示・再来店誘導の要素を含めます。"
    - name: "店長・スタッフで確認する"
      text: "作成したテンプレートを店長・スタッフで確認。表現の違和感や実態との乖離がないかチェックします。"
    - name: "テンプレートを修正・確定する"
      text: "フィードバックを反映してテンプレートを修正。最終版を確定し、使い方のルールを決めます。"
    - name: "ツールに登録・共有する"
      text: "確定したテンプレートをGoogleスプレッドシートやツールに登録。全スタッフがアクセスできるようにします。"
---
...
> **💡 ヒント**: 軽度のクレーム返信テンプレートは[軽度クレーム対応一覧](/mild-response/)、エスカレーション返信は[エスカレーション対応一覧](/escalation/)、業種別テンプレートは[業種別対応一覧](/industry-specific/)をご覧ください。高評価返信は[高評価口コミ返信ガイド](/playbook/positive-review-response)もご参照ください。
...
### Q1: テンプレートを使うと「テンプレ感」が出ませんか？

**A**: テンプレートはあくまで「骨格」です。お客様の名前、具体的なメニュー名、来店日時などの固有情報を必ず入れ、20〜30%は個別にカスタマイズすることで自然な返信になります。

### Q2: テンプレートは何種類くらい用意すべきですか？

**A**: 最低でも評価別（★1-2、★3、★4-5）×クレーム内容別（待ち時間、接客、価格、品質）で12パターンを用意するのが理想です。最初は頻出する5パターンから始めて、運用しながら増やしていくのがおすすめです。

### Q3: 複数店舗で統一したテンプレートを使うべきですか？

**A**: 基本テンプレートは統一し、店舗ごとの特徴（立地、客層、提供サービス）に応じたカスタマイズ部分を設けるのがベストです。完全統一だと店舗の個性が出ず、完全バラバラだと品質管理が困難になります。
