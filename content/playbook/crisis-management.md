...
description: "口コミ炎上の兆候と緊急対応5ステップを解説。初動24時間の行動、公開謝罪のタイミング、改善策の提示方法から信頼回復までのロードマップを実践的に詳しく解説します。"
date: "2025-01-13"
author: "編集部"
category: "playbook"
...
cta: "tool"
howto:
  name: "口コミ炎上時の緊急対応5ステップ"
  description: "口コミ炎上の初動から信頼回復までの緊急対応フロー。"
  totalTime: "P3M"
  steps:
    - name: "初動対応（24時間以内）"
      text: "炎上を検知したら、対策チームを招集し、拡散状況を把握。新たな投稿・SNS発信を一時停止し、状況整理に集中します。"
    - name: "事実確認（48時間以内）"
      text: "該当スタッフへのヒアリング、防犯カメラ・予約記録の確認、時系列での事実整理を行います。"
    - name: "公開謝罪（72時間以内）"
      text: "事実確認に基づき、該当プラットフォームで公開謝罪。具体的な改善策と実施時期を明示します。"
    - name: "改善策の実施（1週間以内）"
      text: "公開謝罪で約束した改善策を実際に実施。スタッフ研修、オペレーション変更などを行います。"
    - name: "継続的なフォローアップ（1〜3ヶ月）"
      text: "改善結果のモニタリング、口コミ評価の推移確認、再発防止策の定着を図ります。"
---
...
### Q1: 炎上は何件の低評価レビューから「炎上」と判断すべきですか？

**A**: 24時間以内に3件以上の低評価レビューが投稿された場合、または1件でもSNSで拡散されている場合は炎上の兆候として対応を開始すべきです。早期発見・早期対応が被害の最小化につながります。

### Q2: 炎上中にSNSで反論しても良いですか？

**A**: 炎上中のSNSでの反論は原則として避けるべきです。反論が新たな批判を呼び、火に油を注ぐ結果になりやすいためです。まずは該当プラットフォームで事実に基づく誠実な謝罪を行い、SNSでの発信は沈静化後に行いましょう。

### Q3: 弁護士に相談すべきタイミングはいつですか？

**A**: 名誉毀損レベルの表現（「詐欺」「犯罪」など）が含まれる場合、業務に明確な損害が出ている場合、同一人物による執拗な攻撃が続く場合は、早めに弁護士への相談をおすすめします。初回相談は無料の事務所も多いです。
