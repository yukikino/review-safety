...
description: "★1レビュー対応の完全フロー。事実確認、スタッフヒアリング、記録保存、公開返信、削除依頼の判断基準まで、初動から解決までのステップを実務で使える形で詳しく解説します。"
date: "2025-01-13"
author: "編集部"
category: "playbook"
...
cta: "mixed"
howto:
  name: "低評価レビューが来たら最初にやるべきこと"
  description: "★1レビュー対応の完全フロー。証拠保存から公開返信、改善実施までのステップ。"
  totalTime: "PT60M"
  steps:
    - name: "証拠を保存する"
      text: "レビューのスクリーンショットを保存。URL、投稿日時、評価、投稿者プロフィール、他のレビュー履歴を記録します。"
    - name: "内容を冷静に読む"
      text: "感情的にならず、具体的な事実が書かれているか、主観的評価か客観的事実か、事実と異なる内容が含まれているかを確認します。"
    - name: "レビューの種類を見極める"
      text: "通常クレーム（mild-response）、強めクレーム（escalation）、悪質な誹謗中傷の3つのフェーズに分類します。"
    - name: "スタッフへヒアリング"
      text: "該当スタッフにいつ誰が接客したか、お客様の特徴、何があったか、どう対応したかを30分以内に確認します。"
    - name: "公開返信を準備して投稿"
      text: "謝罪、簡潔な事実確認、改善の姿勢、再来店の誘導を含む返信文を準備し、24時間以内に投稿します。"
---
...
> **💡 ヒント**: 軽度のクレームへの対応は[軽度クレーム対応一覧](/mild-response/)、エスカレーション対応は[エスカレーション対応一覧](/escalation/)、業種別の対応は[業種別対応一覧](/industry-specific/)をご覧ください。運用マニュアルの他の記事は[運用マニュアル一覧](/playbook/)で確認できます。
...
### Q1: 低評価レビューにはすぐに返信すべきですか？

**A**: 24時間以内の返信が理想的です。迅速な対応は第三者（潜在顧客）に「この店は誠実だ」という印象を与えます。ただし、感情的にならず事実確認をしてから返信しましょう。

### Q2: 削除依頼はどのような場合に出せますか？

**A**: 来店していないのにレビューを投稿した場合、定休日に来店したと書かれている場合、全く別の店舗の話が書かれている場合など、明らかに虚偽の内容やGoogleのポリシー違反に該当するケースで削除申請が可能です。

### Q3: スタッフへのヒアリングで注意すべきことは？

**A**: スタッフを責めるのではなく、事実確認が目的であることを明確に伝えましょう。「いつ、誰が、何があったか」を記録に残すことが重要です。責任追及の場にならないよう配慮してください。
